...
def load(f_path):
	...
	f.close()
	# Final attention scores will have almost same values for all sentence if input is normalized
	#normalization
	...
	return i2w, w2i, sents, lines, w_pos, w_concept, entities
...
if __name__ == '__main__':
	...
	seqs, i2w, w2i, data_xy, sents, last_sents = word_sequence(base_path)